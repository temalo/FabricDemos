...
dataset = "IndustrialSupplyModel" # Enter the name or ID of the semantic model
workspace = "FabricWorkspace" # Enter the workspace name or ID in which the semantic model exists
